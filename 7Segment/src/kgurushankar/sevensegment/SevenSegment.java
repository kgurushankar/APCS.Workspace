...
public class SevenSegment extends JPanel implements ActionListener {
	...
	public void paintComponent(Graphics g) {
		...
		segments[0] = number[3] || number[1] || (number[0] == number[2]);
		...
		segments[5] = !number[0] && (number[2] || !number[1]) || number[3] || (number[2] && !number[1]);
		segments[6] = number[3] || (number[2] != number[1]) || (!number[0] && number[1]);

		/*
		 * segments[2] = segments[3] = segments[4] = segments[5] = segments[6] =
		 */
